...
public class MenuManagerGUI {
	...
	public MenuManagerGUI() {
		...
		listMenus.setBounds(400, 50, 350, 515);
		listMenus.setSelectionMode(ListSelectionModel.SINGLE_INTERVAL_SELECTION);
		listMenus.setLayoutOrientation(JList.HORIZONTAL_WRAP);
		listMenus.setBorder(BorderFactory.createEtchedBorder(EtchedBorder.RAISED));
		...
		}); //End btnDeleteAll actionListener
		...
		btnSave.addActionListener(new ActionListener() {
			...
			// If there are no menus to save, send a notification to user that deleting is unnecessary
			} else {
